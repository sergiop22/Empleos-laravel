                ...
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-10">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="name" type="text" class="p-3 bg-gray-100 rounded form-input w-full @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-100 rounded form-input w-full @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email">
